...
import soma.composeapp.generated.resources.Res
import soma.composeapp.generated.resources.add
import soma.composeapp.generated.resources.home
import soma.composeapp.generated.resources.settings
...
private val TOP_LEVEL_ROUTES = mapOf<NavKey, NavBarItem>(
    ...
    RouteB to NavBarItem(icon = Res.drawable.add, description = "Route B"),
    RouteC to NavBarItem(icon = Res.drawable.settings, description = "Route C"),
)
